...
sudo_users = {SUDO,948940469,948940469}   
...
if tonumber(user_id) == tonumber(948940469) then  
var = true  
elseif tonumber(user_id) == tonumber(948940469) then
var = true  
...
local FeEtO1_Msg = database:get(bot_id.."FeEtO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if FeEtO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
send(msg.chat_id_,0," ※︙ العضو : {["..data.first_name_.."](T.ME/FeEtO)}\n ※︙ ["..FeEtO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ※︙ عذرا » {["..data.first_name_.."](T.ME/FeEtO)}\n ※︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
※︙FeEtO TeAm 
━ ━ ━ ━ ━ ━ ━ ━ ━ 
※︙[Channel FeEtO](t.me/FeEtO1)
※︙[Information](t.me/KKKU9)
※︙[Devlpoer](t.me/NO_NN)
※︙[Group FeEtO](https://t.me/EoEvE)
━ ━ ━ ━ ━ ━ ━ ━ ━ 
※︙[TwAsl Source](t.me/NO_NN)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
database:set(bot_id.."FeEtO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."FeEtO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ※︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."FeEtO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."FeEtO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."FeEtO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."FeEtO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ※︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."FeEtO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."FeEtO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."FeEtO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."FeEtO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ※︙ ارسل الكلمه الان")  
database:set(bot_id.."FeEtO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."FeEtO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."FeEtO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FeEtO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."FeEtO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."FeEtO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."FeEtO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FeEtO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."FeEtO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ※︙ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local FeEtO_Msg = database:get(bot_id.."FeEtO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..FeEtO_Msg.."}\n"    
end  
if #list == 0 then  
...
------------------------------------------------------------------------
local FeEtOAbot = database:get(bot_id.."FeEtO1:Add:Filter:Rp2"..text..result.chat_id_)   
if FeEtOAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"※︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n※︙["..FeEtOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local FeEtO1_Msg = database:get(bot_id.."FeEtO1:Add:Filter:Rp2"..text..result.chat_id_)   
if FeEtO1_Msg then    
send(msg.chat_id_, msg.id_,"※︙"..FeEtO1_Msg)
