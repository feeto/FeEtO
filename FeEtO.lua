...
send(msg.chat_id_,0," ¤ ∫ العضو : {["..data.first_name_.."](T.ME/FeEtO1)}\n ¤ ∫ ["..FeEtO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ¤ ∫ عذرا » {["..data.first_name_.."](T.ME/FeEtO1)}\n ¤ ∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
function amir_FeEtOa_new(FeEtO1,FeEtO2)
